            ...
            <div class="uk-grid">
                ...
                <div class="uk-grid-divider uk-child-width-1-3@m uk-child-width-1-2@s uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <p>Read the Terms of Service and License Agreement for Algo-ai as well as our Portal Usage &amp; Agreements.</p>
                    ...
                    <div>
                        ...
                        <p>Find out more about what information we collect at Algo-ai, how we use it, and what control you have over your data.</p>
                        <ul class="uk-list uk-margin-top">
                ...
                <div class="uk-width-3-5@m">
                    <div class="uk-card uk-card-large uk-card-default in-card-paper">
                        <div class="uk-card-body">
                            ...
                            <p>The information and materials contained in these pages, and the terms, conditions, and descriptions that appear, are subject to change. Unauthorized use of Algo-ai'
                                web sites and systems including but not limited to unauthorized entry into Algo-ai' systems, misuse of passwords, or misuse of any information posted on a site is strictly
                                prohibited. Not all products and services are available in all geographic areas. Your eligibility for particular products and services is subject to final determination by Algo-ai and/or its affiliates. Copyright and Trademark. Copyright in the pages and in the screens displaying the pages, and in the information and material therein and in their arrangement, is owned by Algo-ai unless otherwise indicated.
                                Algo-ai, LTD and the Algo-ai are trademarks and service marks of Algo-ai and are used and/or registered throughout the world. Algo-ai, Ltd and their subsidiaries also claim rights in certain other trademarks and service marks contained in these web pages.</p>

                            <p><b>CUSTOMER TRADING AGREEMENT</b></p>
                            <p>This Client Trading Agreement("Agreement") is between Algo-ai Limited and its affiliates, operator of the brand name Algo-ai (hereinafter: "Algo-ai")
                            ...
                            <p>1. General Services Rule: Client may enter into transactions with Algo-ai, in connection with spot and forward foreign currency contracts,
                                foreign currencies swap transactions, and such other transactions as Algo-ai may from time to time make available (the “Services”).</p>
                            ...
                            <p>3. Direct Relationship: Unless otherwise agreed in writing, Algo-ai and Client each enter into this Agreement as principal and Algo-ai will not accept an
                                undisclosed/unapproved principal acting through Client. With regard to such a principal, Client agrees to provide Algo-ai with its identity, personal information,
                                and other information that Algo-ai may seek.</p>
                            <p>4. No Recommendation or Solicitation: Algo-ai does not recommend, solicit, offer, advise, suggest, concur on the merits of, or otherwise provide any opinion
                                ...
                                with Algo-ai should be construed in this manner.</p>
                            <p>5. Errors: Quotations provided by Algo-ai, via third parties or otherwise, may be incorrect for any reason. Following a transaction involving such quotation
                                errors, Algo-ai in its discretion reserves the right to correct the affected account balance. Any dispute arising from such errors or corrections will be
                            ...
                            <p>6. Market Fluctuations: Client acknowledges that the market for currency is subject to sudden changes due news events and other announcements, acts of war or
                                ...
                                factors beyond Algo-ai' control. Algo-ai may determine in its sole discretion that an emergency or exceptional market condition exists, in which case it
                            ...
                            <p>8. Trading Indices: The Client hereby acknowledge that he is aware that in the case of Contract for Difference (CFD) trade, Algo-ai shall open its trading
                                within 5 minutes of the opening of the relevant market. Algo-ai reserves the right not to accept any trade of such instrument during the first 5 minutes of the
                                trading day. Algo-ai reserves its right to cancel any trade, in its own discretion, of such instrument made during the first 5 minutes of the trading day.</p>
                            <p>9. Algo-ai shall execute the Client’s withdrawal within 96 working hours once all the above conditions are met and upon approval of such by the Algo-ai
                                ...
                                destination country or any other 3rd party involved in the transfer of funds. Algo-ai shall not be liable for any fund transfer delay caused by such 3rd party.</p>
                            <p>10. Complaints: - Based on an operational agreement with Algo-ai Ltd., we are responsible for complaints where End-Users have
                                ...
                                at : support@Algo-ai.com. We have put in place formal procedures for handling complaints fairly and promptly, and each such filed inquiry shall be
                            ...
                            <ul class="in-faq-5 uk-accordion" data-uk-accordion="collapsible: false">
                                ...
                                <li>
                                    ...
                                    <div class="uk-accordion-content" hidden="">
                                        ...
                                        We accept that customer trust is the establishment of our business. That is the reason we are straightforward about how we gather and utilize the data you give us, and we need to feature the decisions you have for getting to and controlling your data. If it's not too much trouble see beneath to figure out how our different business lines utilize your data to give you the best customer experience. As usual, you can get in touch with us at support@Algo-ai.com with any inquiries or criticism.
                                ...
                                <li>
                                    ...
                                    <div class="uk-accordion-content" hidden="">
                                        <p>Our Company trademarks include the following list. The absence of any Company trademark, product name, service name, or any other name from this list does not belong to Algo-ai Company intellectual property rights.</p>
                            ...
                            <div class="uk-card uk-card-default uk-card-small uk-card-body uk-border-rounded uk-margin-medium-top">
                                <p class="uk-text-small">For general inquiries please contact <a class="uk-text-lowercase uk-link" href="mailto:">legal@Algo-ai.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
